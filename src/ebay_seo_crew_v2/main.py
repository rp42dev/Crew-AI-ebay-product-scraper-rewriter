...
class EbaySeoPipeline(Flow):
    ...
    def scrape_details(self, listings):
        ...
        path = f"src/ebay_seo_crew_v2/output/detailed_listings_{timestamp}.json"
    ...
    def rewrite_seo(self, products):
        ...
        with open("src/ebay_seo_crew_v2/output/seo_rewritten_listings.md", "w", encoding="utf-8") as f:
            for r in results:
